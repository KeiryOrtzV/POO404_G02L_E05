...
<div class="">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody>
        <%
            st = conexion.prepareStatement("SELECT p.id_persona,p.nombre_persona,p.edad_persona,p.sexo_persona,p.id_ocupacion,p.fecha_n ac, p.usuario, o.ocupacion FROM persona p INNER JOIN ocupaciones o on p.id_ocupacion= o.id_ocupacion");
                    rs = st.executeQuery();
            while (rs.next()) {
        %>
        <tr>
