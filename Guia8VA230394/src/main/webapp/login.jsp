                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <%--@declare id="saveform"--%><button type="button" class="btn btn-secondary" data-bsdismiss="modal">Close</button>
                                    <input type="submit" name="submit" class="btn btn-info btn-md" form="saveform" value="Enviar">
                                </div>
                            </div>
                        </div>
                    </div>
